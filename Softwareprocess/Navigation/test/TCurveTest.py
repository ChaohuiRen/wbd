...
#            none ... x is pre-validated   
    ...
    def test500_010_ShouldCalculateIntegrateForF1(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,7,myT.f1), 0.5)
    def test500_020_ShouldCalculateIntegrateForF2(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,7,myT.f2),0.3333)
    def test500_030_ShouldCalculateIntegrateForF3(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,7,myT.f3), 0.1428)
    def test500_040_ShouldCalculateIntegrateForF4(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,7,myT.f4), 0.0099)
